...
const TermsOfService = () => {
  ...
  return (
    <SharedPolicyLayout
      ...
      keywords="terms of service, terms and conditions, sandipandas.blog, Sandipan Das, blog usage terms"
    >
      <h1 style={styles.title}>Terms of Service for sandipandas.blog</h1>
      <p style={styles.lastUpdated}>Last updated: October 21, 2024</p>
      <p style={styles.paragraph}>Please read these Terms of Service ("Terms") carefully before using sandipandas.blog (the "Service") operated by Sandipan Das ("us", "we", or "our").</p>

      <h2 style={styles.heading}>1. Acceptance of Terms</h2>
      <p style={styles.paragraph}>By accessing sandipandas.blog, you agree to these Terms of Service and all applicable laws. If you disagree with any part of the terms, please do not use our website.</p>

      <h2 style={styles.heading}>2. Use License</h2>
      <p style={styles.paragraph}>We grant you permission to view and download a single copy of the content on sandipandas.blog for personal, non-commercial use only. This license does not include any resale or commercial use of our website or its contents.</p>

      <h2 style={styles.heading}>3. Disclaimer</h2>
      <p style={styles.paragraph}>The content on sandipandas.blog is provided "as is". We make no warranties about the completeness, reliability, or accuracy of this information.</p>

      <h2 style={styles.heading}>4. Limitations</h2>
      <p style={styles.paragraph}>Sandipan Das shall not be liable for any damages arising from the use or inability to use the materials on sandipandas.blog.</p>

      <h2 style={styles.heading}>5. Revisions</h2>
      <p style={styles.paragraph}>We may update these Terms of Service at any time. By continuing to use sandipandas.blog after changes are made, you agree to be bound by the revised terms.</p>

      <h2 style={styles.heading}>6. Governing Law</h2>
      <p style={styles.paragraph}>These Terms shall be governed by and construed in accordance with the laws of India.</p>
